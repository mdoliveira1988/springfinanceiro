package br.com.stark.starkfinanceiro.starkexcepition;
...
@ControllerAdvice
public class StarkHandlerExcepition extends ResponseEntityExceptionHandler{
	...
	public List<Erro> criaListaDeErros(BindingResult bindingResults){
